...

{
           order.map((item) => item.status == 1 &&  (
              ...
              <HStack space={3} bg={Colors.gray}>
                    <Text color={Colors.black} fontSize="14px" bold ml={1} mt={2}>Trạng thái: <Text fontWeight="normal" color={Colors.lightblue}>Đang chờ xác nhận</Text></Text>
