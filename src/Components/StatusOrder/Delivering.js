...

{
           order.map((item) => item.status == 3 &&  (
              ...
              <HStack space={3} bg={Colors.gray}>
                    <Text color={Colors.black} fontSize="14px" bold ml={1} mt={2}>Trạng thái: <Text fontWeight="normal" color={Colors.lightblue}>Đang giao hàng</Text></Text>
